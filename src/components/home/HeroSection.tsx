        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center py-16 lg:py-24">
          ...
          <div className="space-y-8">
            ...
            <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-lg">
              HashtagBillionaire is more than a store — it is a platform for self-expression,
              personal branding, and individuality through customized products. Every item you
              create here becomes a reflection of who you are and what you stand for.
            </p>
            <div className="flex flex-wrap gap-3 pt-2">
              <Link to="/categories">
                <Button variant="hero" size="lg" className="gap-2 rounded-lg px-8">
                  Shop Now
